...
export const GUIDE_TIPS: GuideTip[] = [
  ...
  },
  {
    ...
    body: 'Вкладка «Агенты»: создать, переименовать, удалить, переключить слот. До 8 сессий — каждая помнит репо и историю Cursor.',
  },
  {
    id: 'approvals',
    topic: 'Безопасность',
    title: 'План ждёт owner',
    body: 'После /plan или /task кнопки Approve одноразовые и с TTL — в Telegram-боте. Режим «Сделать» идёт без этого шага.',
  },
  {
    id: 'queue',
    topic: 'Очередь',
