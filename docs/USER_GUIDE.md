...
В Mini App (вкладка диалога): переключатель **Спросить / План / Действие** над орбом
...
live queue, вкладка **Пульт**, вкладка **Лента** (недавние прогоны с статусом
и репозиторием + читаемая активность событий), worker health.
