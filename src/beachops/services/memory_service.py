...
from beachops.domain.models import MemoryEntry, RunSummary
...
class MemoryService:
    ...
    async def list_runs_for_retry(
        ...
        *,
        ...
        return await self._repo.list_runs_for_retry(
            tg_user_id,
            repo_id=repo_id,
            limit=limit or self._settings.memory_list_limit,
        )
    ...
    async def get_by_run_id(self, tg_user_id: int, run_id: str) -> MemoryEntry | None:
        return await self._repo.get_by_run_id(tg_user_id, run_id)
