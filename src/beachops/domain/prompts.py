...
- `{default_branch}` — база только для чтения. Коммить и пушь в отдельную feature-ветку этого run, открой PR.
- Не merge, не force-push, не трогай main/master, не удаляй ветки.
...
- Укажи PR для review; не предлагай merge или deploy.
