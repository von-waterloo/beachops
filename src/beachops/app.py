...
def create_application(settings: Settings) -> Application:
    application = (
        ...
        .get_updates_connect_timeout(settings.telegram_connect_timeout_sec)
        .get_updates_read_timeout(settings.telegram_get_updates_timeout_sec)
        .get_updates_write_timeout(settings.telegram_write_timeout_sec)
        .get_updates_pool_timeout(settings.telegram_pool_timeout_sec)
        .media_write_timeout(settings.telegram_write_timeout_sec)
